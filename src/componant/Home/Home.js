        ...
        <div>
            ...
            <div className="hero mt-28 mb-28">
                <div className="hero-content flex-col lg:flex-row">
                    ...
                    {/* <div className="divider divider-horizontal">A</div>
                    <div className="divider divider-horizontal">Y</div>
                    <div className="divider divider-horizontal">E</div>
                    <div className="divider divider-horizontal">E</div>
                    <div className="divider divider-horizontal">M</div> */}
